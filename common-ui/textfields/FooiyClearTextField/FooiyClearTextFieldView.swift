...
class FooiyClearTextFieldView: UIView {
    ...
    private let stackView: UIStackView = {
        ...
        stackView.spacing = FooiyTextField.Dimension.subviewSpacing
        return stackView
    }()
    ...
    public let textField: FooiyClearTextField = {
        let textField = FooiyClearTextField()
